        ...
        <div class="card-body">
            <form action="/nilaikuliah/store" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NilaiAngka" id="NilaiAngka" class="form-control" maxlength="30" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="SKS" id="SKS" class="form-control" maxlength="30" required>
                    </div>
                </div>
